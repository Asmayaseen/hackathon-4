...
Teaches — Delivers course content with intelligent navigation
Explains — Breaks down concepts at the learner's level
Quizzes — Tests understanding with immediate feedback
Tracks — Monitors progress and identifies knowledge gaps
Adapts — Adjusts difficulty and approach (Phase 2) 
Web App — Provides a Comprehensive Stand Alone Web App (Phase 3)
